      ...
      <Container sx={{ py: 8 }}>
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            <Typography
              variant='h3'
              sx={{ fontWeight: 700, mb: 4, textAlign: 'left' }}
            >
              Instant gas-free swaps
            </Typography>
            <List>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  ...
                  <Typography variant='body1' color='#b5b5b5'>
                    Say goodbye to sandwich attacks and <br />
                    frontrunning. Protect from MEV without <br /> a second
                    thought.
                    <Button
                      href='#'
                      sx={{
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  ...
                  <Typography variant='body1' color='#b5b5b5'>
                    Save on slippage and cut
                    <br /> down opportunity cost.
                  </Typography>
                </CardContent>
              </Card>
            </Grid>
            ...
            <Grid item xs={12} sm={6} md={4}>
              ...
              >
                ...
                >
                  ...
                  <Typography variant='body1' color='#b5b5b5'>
                    Say goodbye to sandwich attacks and <br />
                    frontrunning. Protect from MEV without
                    <br /> a second thought.
                    <Button
                      href='#'
                      sx={{
